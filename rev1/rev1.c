...
enum layers { _GRAPHITE, _QWERTY, _LOWER, _RAISE, _ADJUST };
//enum layers {, _QWERTY, _LOWER, _RAISE, _ADJUST };

extern const char* const PROGMEM LAYER_NAMES[];
...
void render_logo(void) {
    ...
    switch (default_layer) {
        // case 2:
        //     oled_write(LAYER_NAMES[2], false);
        //     break;
        case 1:
            oled_write(LAYER_NAMES[1], false);
            break;
        case 0:
            oled_write(LAYER_NAMES[0], false);
            break;
    }

    //oled_write_P(kimiko_logo, false);
 //    oled_write_P(PSTR("Kimik"), false);
    //uint8_t current_layer = get_highest_layer(layer_state);
//    char ch[4];
    // sprintf(ch, "%u", layer_state);
    // oled_write(ch, false);
    // sprintf(ch, "%u", default_layer) ;
    // oled_write(ch, false);

//    oled_write(LAYER_NAMES[default_layer], false);
